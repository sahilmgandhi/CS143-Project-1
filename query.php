...
?>
    ...
    <h4>This is the web page for the first part of project 1 for CS 143.</h4>
    <p>Please enter a SQL query below in order to get started!</p>
<style>
    body {
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
    <br><br>
        <textarea name="query" rows="5" cols="40"> <?php if(isset($_POST['query'])) { 
                echo htmlentities ($_POST['query']); }?></textarea>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = processQueryString($_POST["query"]);
...
function processQueryString($data) {
    $data = trim($data);
    return $data;
}
