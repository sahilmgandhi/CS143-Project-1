        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <input type="text" id="name" name="name" placeholder="Director Full Name"
                           size="20 value="<?php echo isset($_POST['name']) && $directorErrorFlag ? $_POST['name'] : '' ?>
                    "">
                ...
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <input type="text" id="name" name="name" placeholder="Actor Full Name" size="20"
                           value="<?php echo isset($_POST['name']) && $actorErrorFlag ? $_POST['name'] : '' ?>">
                    <input type="text" id="role" name="role" placeholder="Actor Role" size="50" maxlength="50"
                           value="<?php echo isset($_POST['role']) && $actorErrorFlag ? $_POST['role'] : '' ?>">
                    <input type="hidden" name="id" value="<?php echo $id; ?>"/>
                ...
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <input type="text" id="comment" name="comment" placeholder="Review/Comment" size="100"
                           maxlength="500"> <br> <br>
                    <input type="hidden" name="id" value="<?php echo $id; ?>"/>
