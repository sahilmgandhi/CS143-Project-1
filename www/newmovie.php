    ...
    <div class=row>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <p>Modify the form below to create a new movie. The first few fields are required, and the
                    ratings/income fields are optional if you want to include that information.</p>
            </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    (Required Fields): <br>
                    <input type="text" id="title" name="title" placeholder="Movie Title" size="20"
                           value="<?php echo isset($_POST['title']) ? $_POST['title'] : '' ?>"> <br> <br>
                    <input type="number" id="year" name="year" placeholder="Movie Year" size="4"
                           value="<?php echo isset($_POST['year']) ? $_POST['year'] : '' ?>"> <br> <br>
                    ...
                    <input type="text" id="company" name="company" placeholder="Production Company" size="50"
                           value="<?php echo isset($_POST['company']) ? $_POST['company'] : '' ?>"> <br> <br>
                    Genre:
                    ...
                    (Optional Fields): <br>
                    IMDB Rating (0-100): <input type="text" name="imdb" maxlength="3" size="3"
                                                value="<?php echo isset($_POST['imdb']) ? $_POST['imdb'] : '' ?>"><br>
                    Rotten Tomatoes Rating (0-100): <input type="text" name="rotten" maxlength="3" size="3"
                                                           value="<?php echo isset($_POST['rotten']) ? $_POST['rotten'] : '' ?>"><br>

                    Tickets Sold: <input type="text" name="tickets"
                                         value="<?php echo isset($_POST['tickets']) ? $_POST['tickets'] : '' ?>"><br>
                    Total Income: <input type="text" name="income"
